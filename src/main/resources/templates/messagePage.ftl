...
<@c.page>
    <div class="py-5 text-center">
        ...
        <img src="https://img.icons8.com/cute-clipart/96/000000/copybook.png" alt=""/>
    </div>

    <#if !isUser>
        <h5>
            <div class="mt-3">
                Поиск заявления по типу
            </div>
        </h5>
            ...
            <div class="card-columns">
                <#list messages as message>
                    <div class="card my-3">
                        ...
                        <#if isManager>
                            <a class="btn btn-outline-success" href="/messagePage/${message.id}"
                               role="button">Одобрить заявление
                            </a>
                        </#if>
                    </div>
                <#else>
