...
<h5><div class="mt-1">${username}</div></h5>
<img src="https://img.icons8.com/color/96/000000/red-panda.png"/>
${message?ifExists}
<form method="post">
...
<div class="row">
      <div class="col-md-4">
        ...
        <p><a class="btn btn-secondary" href="/agreementPage" role="button">Заселиться</a></p>
      </div>
      <div class="col-md-4">
        ...
        <p><a class="btn btn-secondary" href="/agreementPage" role="button">Выселиться</a></p>
      </div>
      <div class="col-md-4">
        ...
        <p><a class="btn btn-secondary" href="/agreementPage" role="button">Продлить</a></p>
      </div>
    </div>
</#if>
